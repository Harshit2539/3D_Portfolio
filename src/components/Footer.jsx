...
export default function Footer() {
  const links = {
    ...
    resources: [
      ...
      { name: 'Naukri', href: personalInfo.naukri }
    ],
    connect: [
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {links.resources.map(link => (
                <li key={link.name}>
                  <a href={link.href} className="text-gray-400 hover:text-primary transition-colors text-sm" target="_blank" rel="noopener noreferrer">
                    {link.name}
                  </a>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
            ...
            <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
